...
class KnowledgeSnapshotResponse(BaseModel):
    ...
    snapshot_id: str = Field(description="The unique identifier of the knowledge snapshot", alias="snapshotId")
    group_id: str = Field(description="The unique identifier of the knowledge group", alias="groupId")
    version: int = Field(description="The version number of the snapshot")
    created_at: str = Field(description="The creation date of the knowledge snapshot in ISO format", alias="createdAt")
