...
class KnowledgeManagementService:
    ...
    async def create_knowledge_group(self, group: models.KnowledgeGroup) -> None:
        ...
        if group.sources:
            await self.group_repo.add_sources_to_group(group.group_id, list(group.sources.values()))
    ...
    async def add_source_to_group(self, group_id: str, source: models.KnowledgeSource) -> models.KnowledgeGroup:
        """
